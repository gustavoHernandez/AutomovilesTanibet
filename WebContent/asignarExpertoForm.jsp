  ...
  <div id="Content">
    ...
    <div class="RightSide" style="width:850px;">
      ...
      <div class="bredCrum" style="margin-bottom:38px;">
        <h4>Autos sin experto asignado...</h4>
      </div>
      				...
      				<ul>
		          		...
		          		<s:else>
		            		...
		            		<div class="catDetail">
		              			...
		              			<form action="asignarExpertoAuto" method="post">
		              			
		              				<div align="center">
		              			
				              			<select name="expertoid">
				              				<s:iterator value="expertos">
				              					<option value="<s:property value="id" />"> <s:property value="nombre_vendedor" />  </option>
				              				</s:iterator>
				              			</select>
				              			<input type="hidden" name="autoid" value="<s:property value="id" />" />
...
<!-- Oculto: Mensaje de advertencia  -->
	...
	<div id="boxes">
		...
		<div id="dialog2" class="window" align="center" style="top: 236.5px; left: 428px; display: none; ">
      		...
      		<h1>Auto asignado al experto correctamente...</h1>
        	<br/><br/>
